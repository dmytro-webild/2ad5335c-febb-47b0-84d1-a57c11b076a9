...
export const metadata: Metadata = {
  title: 'Premium Laundry Services | Laundry Day Made Easy in Augusta, GA',
  description: 'Professional wash & fold laundry service with pickup and delivery in Augusta, GA. Enjoy free time with fresh, folded clothes with Premium Laundry Services.',
